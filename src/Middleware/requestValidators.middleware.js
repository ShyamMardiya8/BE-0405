...
const { staffValidatorSchema, clientValidationSchema, authValidation, formBuilderValidation } = require("../utility/Validators");
...
const requestValidators = {
  ...
  form: (req, res, next) => {
    const validation = formBuilderValidation.safeParse(req.body)
