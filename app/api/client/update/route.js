...
export const PUT = wrapHandler(async (req) => {
  ...
  const fetchedClientData = await clientService.updateClient(clientId, validatedData);
  return NextResponse.json(new ResponseHandler("Updated Successfully", 200, fetchedClientData, true), { status: 200 });
});
