...
export default function TeamPage() {
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-12 text-center space-y-4 shadow-sm animate-fadeIn">
      ...
      <h2 className="text-xl font-bold text-slate-900">My Team Module</h2>
      <p className="text-xs text-slate-500 max-w-md mx-auto">
        Welcome to the My Team panel. Manage technicians, managers, and live location tracking here.
      </p>
    </div>
  );
}
